...
\postdate{}
\date{}
\title{EE 495 Game Theory and Networked Systems \\ Project Proposal}
\author{Chi Li}
\begin{document}
\maketitle
\section{Topic and team}
I am interested in the theory of Markov games. Specifically, I am interestsed in the characterization of equilibria of Markov Games. I will be working alone for the final project.

\section{Description}
Loosely based on Chapter 13.1 and 13.2 of Fudenberg and Triole's textbook \cite{FT}, I will give an introduction for Markov games, and the characterization of Markov perfect equilibrium. As an application, I will model some Markov games that are encountered in daily life. For example, modelling the ``family friendly'' game Monopoly as a finite Markov game, and a 2-player Markov bargaining game as studied by Cripps (hopefully providing a sketch of proof of characterization of equilibira) \cite{Cripps1998}. Finally, moving beyond Markov perfect equilibria, I will explain the folk theorem for Stochastic games, as studied by Dutta \cite{Dutta1995} and Chantal Marlats \cite{Marlats2015}. If there is enough space, I will give a short sketch of the proof.
